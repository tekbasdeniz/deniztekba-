...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${siteUrl}/consulting`, lastModified, changeFrequency: "weekly", priority: 0.9 },
    ...
    { url: `${siteUrl}/policies/dataProtection`, lastModified, changeFrequency: "yearly", priority: 0.3 },
